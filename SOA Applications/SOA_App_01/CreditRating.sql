--------------------------------------------------------
--  File created - Thursday-October-30-2014   
--------------------------------------------------------
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into TEST.CREDIT_RATING (ID_NUM,CREDIT_RATING,NUMBER_OF_CC_CARDS,FIRST_LOAN_ACC_DURATION,LOAN_APPLIED_IN_12_MONTHS,RECENT_ACC_DURATION,NUMBER_OF_ACC_CURRENT_BAL,TOTAL_BALANCE,MISSED_PAYMENT,PAST_DUE_ACCS) values ('9110140924083',911,3,2,1,3,2,2,1,1);
Insert into TEST.CREDIT_RATING (ID_NUM,CREDIT_RATING,NUMBER_OF_CC_CARDS,FIRST_LOAN_ACC_DURATION,LOAN_APPLIED_IN_12_MONTHS,RECENT_ACC_DURATION,NUMBER_OF_ACC_CURRENT_BAL,TOTAL_BALANCE,MISSED_PAYMENT,PAST_DUE_ACCS) values ('9005235609081',879,2,2,2,3,2,1,2,2);
